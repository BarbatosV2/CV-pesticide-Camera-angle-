        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            #vertical angle = 54°       #28.072     #56.144
                    ...
                    if not ox or oy:
                        ...
                        if xyxy==[0,0,0,0]:                             
                            camobjdis = 0
                            print("distance between camera and object =", camobjdis)    #if there is no object
                        else:
                            print("distance between camera and object =", camobjdis)    #if object print distance
                        ...
                        if ox > w:
                            print("the object is on the right") #object left 
                        else:
                            print("the object is on the left")  #object right
